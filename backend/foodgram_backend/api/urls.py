...
urlpatterns = [
    ...
    path('users/<int:pk>/subscribe/', SubscriptionViewSet.as_view({'post': 'subscribe', 'delete': 'unsubscribe'}), name='subscribe-unsubscribe'),
    ...
    path('recipes/<int:pk>/shopping_cart/', RecipeViewSet.as_view({'post': 'add_shopping_cart', 'delete': 'remove_shopping_cart'}), name='add_shopping_cart-remove_shopping_cart'),
    path('recipes/download_shopping_cart/', ShoppingCartViewSet.as_view({'get': 'download_shopping_cart'}), name='download_shopping_cart'),
